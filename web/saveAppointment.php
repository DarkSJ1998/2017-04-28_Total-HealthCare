...
<html>
<head>
<title>Appointment Booking : Message | Total HealthCare</title>
<!-- for-mobile-apps -->
...
<?php
	...
	$query = "insert into `appointmentdetails` (`Name`, `Email`, `Age`, `PhoneNumber`,`date_Appt.` ,`deptt.`) 
	values ('$name', '$emailID', '$age','$phoneNumber', '$date', '$dept')";

	if(mysqli_query($connection, $query)) {
		echo "
			<div style='background-image:url(images/messageBlurBG.png);color:white;font-family:Calibri;;font-size:20px;' vlink = 'white' alink = 'white'>
			<center><br>
					<img src = 'check.png'>
			...
			&nbsp Your appointment has been recorded in our system <br> &nbsp
			</div>
		";
		...
		echo "
			...
			&nbsp Something went wrong : ".mysqli_error($connection)." <br> &nbsp ";
