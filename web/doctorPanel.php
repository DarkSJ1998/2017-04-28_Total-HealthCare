				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="doctorPanel.php" class="menu__link"> Dashboard </a></li>
...
<div style='background-image:url("images/messageBlurBG.png");color:white;font-family:Calibri;' vlink = 'white' alink = 'white'>
	<center><br>
			<img src = 'user-192.png'>&nbsp &nbsp
			<h2 style = 'font-size:60px;'>Welcome Doctor!</h2>
	
			<hr color = 'white'>
			
			<p style = 'font-size:30px;'> Here you can get all the information about your patients </p>
			<p> &nbsp </p>
	
	<div style = 'font-size:25px;color:white;font-family:Calibri;' vlink = 'white' alink = 'white' link = 'white'>
	<h3 class="t-button"><br>
		<form action = "showAppointmentsByDate.php" method = "POST">
			--- <u>Check Appointments</u> ---
			<h4>Search by Date (MM/DD/YYYY) : 
			<input style = "color:black;" class="date" name="date" id="datepicker" type="text" value="MM/DD/YYYY" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MM/DD/YYYY';}" required="yes">
			
			<button type = "submit" class="label label-primary">Show Appointments for the date</button> </h4>
		</form>
		
		<h4><a href="showAllAppointments.php"><span class="label label-primary">Show All The Appointments</span></a></h4><br>
	</h3>
	</center>
	</div>
</div>
